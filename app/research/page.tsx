        ...
        <div className="container mx-auto">
          ...
          <div className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="bg-white shadow-lg rounded-lg p-6">
                <img src="https://placehold.co/300x200?text=Chatbot+1" alt="Chatbot Project" className="w-full h-auto object-cover rounded-md" />
                <h3 className="text-xl font-bold mb-2 mt-4">Bayesian Chatbot Models</h3>
              ...
              <div className="bg-white shadow-lg rounded-lg p-6">
                <img src="https://placehold.co/300x200?text=Thematic+1" alt="Thematic Analysis" className="w-full h-auto object-cover rounded-md" />
                <h3 className="text-xl font-bold mb-2 mt-4">Thematic Analysis in Human-AI Interaction</h3>
                <p className="text-base">
              ...
              <div className="bg-white shadow-lg rounded-lg p-6">
                <img src="https://placehold.co/300x200?text=BigData+1" alt="Big Data Analytics" className="w-full h-auto object-cover rounded-md" />
                <h3 className="text-xl font-bold mb-2 mt-4">Big Data Healthcare Analytics</h3>
                <p className="text-base">
          ...
          <div className="mb-16">
            ...
            <div className="bg-white shadow-lg rounded-lg p-6 mx-auto max-w-2xl">
              <img src="https://placehold.co/300x200?text=Gesture+1" alt="Gesture Study" className="w-full h-auto object-cover rounded-md" />
              <h3 className="text-xl font-bold mb-2 mt-4">Gesture Study Research</h3>
              <p className="text-base">
